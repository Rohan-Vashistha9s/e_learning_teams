...
const Literature = () => {
  ...
  <div className="absolute top-[70px] left-1/2 transform -translate-x-1/2 -translate-y-12 sm:left-[20px] sm:translate-x-0">
    <div className="rounded-full w-[150px] h-[150px] sm:w-[250px] sm:h-[250px] border-4 border-white overflow-hidden">
      <img
  ...
  <div className="bg-white/80 shadow-lg rounded-[20px] overflow-hidden absolute top-[160px] sm:top-10 left-1/2 sm:left-[700px] transform -translate-x-1/2 w-[90%] sm:w-[70.5%]">
    <div className="relative p-4 sm:p-6">
      <button className="absolute top-4 sm:top-6 right-4 sm:right-6 bg-teal-500 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-lg">
        Enroll Now
      </button>

      <div className="top-6">
        <h2 className="text-xl sm:text-2xl text-gray-800 font-semibold">John Anderson</h2>
        <p className="text-gray-600 text-[13px] sm:text-[15px]">Assistant Professor at McMaster University</p>
      </div>

      <p className="mt-6 sm:mt-8 text-gray-600 text-[13px] sm:text-[15px]">
      ...
      <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:space-x-[250px]">
...
<div className="max-w-7xl mx-4 sm:mx-20 mt-10 p-4">
  ...
  <h2 className="text-xl sm:text-2xl text-gray-800 font-semibold mb-4">Literature Course</h2>

  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
    {books.map((book, index) => (
      <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden">
        <img className="w-full p-4 h-[240px] sm:h-[360px] object-cover" src={book.imgSrc} alt={book.title} />
  ...
  <div className="flex justify-center mt-6 space-x-2">
    <button className="px-2 sm:px-3 py-1 bg-teal-100 text-teal-500">
      <FontAwesomeIcon icon={faAngleLeft} />
    </button>
    <button className="px-2 sm:px-3 py-1 text-gray-700">1</button>
    <button className="px-2 sm:px-3 py-1 text-gray-700">2</button>
    <button className="px-2 sm:px-3 py-1 bg-teal-500 text-white">3</button>
    <button className="px-2 sm:px-3 py-1 text-gray-700">4</button>
    <button className="px-2 sm:px-3 py-1 text-gray-700">5</button>
    <button className="px-2 sm:px-3 py-1 bg-teal-100 text-teal-500">
