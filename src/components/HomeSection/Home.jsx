    ...
    <div className="font-poppins">
        ...
        <header className="flex justify-between items-center p-5 w-full">
          ...
          <nav className="space-x-4">
            <ul className="flex space-x-12 text-white cursor-pointer">
              ...
              <Link
                to="/login"
                className="btn-head-l mx-[5px] bg-white py-1.5 px-6 text-black rounded-full shadow-[0px_20px_24px_0px_rgba(0,0,0,0.08)]"
              >
                Login
              </Link>
              <Link
                to="/login"
                className="btn-head-s mx-[5px] bg-white/30 py-1.5 px-6 text-white rounded-full shadow-[0px_20px_24px_0px_rgba(0,0,0,0.08)]"
              >
                Sign Up
              </Link>
            </ul>
          ...
          <i
            className="fa-regular fa-bars-staggered text-white lg:hidden"
            id="menu-btn"
          ></i>
        </header>
          ...
          <div className="mx-auto flex flex-col lg:flex-row items-center">
            <div className="w-[50rem] left-[9rem] text-white relative">
              ...
              <p className="leading-10 font-semibold my-6">
                <span>
                  TOTC is an interesting platform that will teach you <br /> in
                  more an interactive way
                </span>
              </p>
              <div className="flex space-x-4">
                <button className="bg-[#91d5d6] hover:bg-[#3b8384] text-white py-2 px-4 rounded-3xl h-[3rem] w-[9.5rem]">
                  Join for free
                </button>
                <p className="flex items-center">
                  <FontAwesomeIcon
                    icon={faCirclePlay}
                    className="w-[3rem] relative bottom-2 h-[4rem]"
                  />{" "}
                  <span className="mx-6 bottom-2 relative text-black">
                    {" "}
                    Watch how it works
                  </span>
                </p>
            ...
            <div className="">
              <img src={hero} alt="hero-img" className="w-[32rem] h-[40rem]" />
            ...
            <Link className="dropdown-item block px-4 py-2 text-gray-800 hover:bg-gray-100" to="/Course-Full-View">
              Full View Calendar
                ...
                <div className="py-16">
                  ...
                  <button className="bg-[#D8587E] relative top-[30rem] font-semibold items-center py-2 px-4 w-[8rem] rounded-2xl left-[5rem] text-white">
                    Join Now
                  </button>
                  <div className="absolute top-[250px] -right-[9rem] w-[18rem] bg-white/70 p-4 flex items-center text-black space-x-4 rounded-lg">
                    <FontAwesomeIcon
      ...
      <div className="text-center py-16">
        ...
        <div className="flex justify-between w-[50rem] m-auto mt-8">
          <div className="text-[#49BBBD] text-6xl ">
            <h4>15k+</h4>
          </div>
          <div className="text-[#49BBBD] text-6xl ">
            <h4>75%</h4>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full sm:w-1/2 lg:w-1/3 p-5">
              <div className="all-in-inner bg-white p-5 rounded-lg shadow-lg hover:transform hover:-translate-y-2 transition duration-300 text-center h-full">
                <FontAwesomeIcon
                  icon={faFileInvoice}
                  className="text-white p-5 rounded-full shadow-lg"
                  style={{ backgroundColor: "#5B72EE" }}
                />
                <h4 className="text-2xl font-medium text-[#2F327D] mt-5">
                  Online Billing,
      ...
      <div id="wit" className="py-16">
        ...
        <p className="text-center text-gray-600 mt-4 leading-relaxed">
          ...
          exams; monitor <br />
          due dates; grade results and provide students with feedback all in one
          place.
        </p>
        ...
        <div className="wit-img-sec mt-12">
          <div className="flex flex-wrap  justify-center">
            <div className="w-full sm:w-2/3 md:w-1/3 px-4">
              <div
                className="wit-inner bg-cover bg-center bg-no-repeat transition-transform duration-300 rounded-lg h-[250px] m-[20px] p-4 flex items-center justify-center text-center hover:transform hover:-translate-y-2"
                style={{
                  backgroundImage: `linear-gradient(#1414148f, rgba(23, 23, 23, 0.43)), url(${wit01})`,
                }}
              >
                <div>
            ...
            <div className="w-full sm:w-2/3 md:w-1/3 px-4">
              <div
                className="wit-inner bg-cover bg-center bg-no-repeat transition-transform duration-300 rounded-lg h-[250px] m-[20px] p-4 flex items-center justify-center text-center hover:transform hover:-translate-y-2"
                style={{
                  backgroundImage: `linear-gradient(#1414148f, rgba(23, 23, 23, 0.43)), url(${wit02})`,
                }}
              >
                <div>
                  <h1 className="text-white text-xl font-bold">
      ...
      <div id="classroom" className="max-w-5xl mx-auto my-10 px-5 py-5">
        <div className="flex flex-col md:flex-row items-center">
          <div className="class-inner md:w-1/2 p-5">
            ...
            <a
              href="#"
              className="text-[#696984] pb-2 border-b-2 border-transparent hover:border-[#696984] transition-all"
            >
              Learn More
            </a>
          </div>
          ...
          <div className="lg:w-7/12">
            <div className="relative px-7" id="feature-img">
              ...
              <div className="f-head bg-[#EAEAEA] h-[25px] w-[105%] flex items-center">
                <i
                  className="fa-solid fa-circle text-xs ml-2"
                  style={{ color: "#ff0000" }}
                ></i>
                <i
                  className="fa-solid fa-circle text-xs ml-2"
                    ...
                    <div className="f-img-name relative">
                      ...
                      <div className="f-user-name absolute bottom-5 left-2.5 bg-[#b2b5bba6] rounded-xl p-2">
                        <p className="text-white text-xs">
                          <span className="bg-[#3793FF] px-1.5 py-0.5 rounded">
                            Instructor
                          </span>{" "}
                          Eveny Howard
                        </p>
            ...
            <div className="bg-white shadow-lg p-5 rounded-2xl relative">
              ...
              <div className="absolute bottom-0 right-0 p-4 bg-white shadow-lg rounded-2xl">
                <div className="flex items-center space-x-4">
                  <FontAwesomeIcon
                    icon={faPaperPlane}
                    className="text-[#41be99] text-2xl p-2 bg-[#D8F9ED] rounded-full"
                  />
              ...
              <div className="absolute top-0 right-10 p-3 rounded-full bg-white shadow-md">
                <FontAwesomeIcon
                  icon={faCircleXmark}
                  className="text-[#ee3175] text-3xl"
                />
              </div>
              ...
              <div className="absolute top-10 right-0 p-3 rounded-full bg-white shadow-md">
                <FontAwesomeIcon
                  icon={faCircleCheck}
                  className="text-[#2dd38e] text-3xl"
                />
              </div>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-6/12 p-5">
            <div className="space-y-5">
              <h1 className="text-3xl font-medium leading-tight">
                <span className="text-[#49BBBD]">Class Management</span>
                <br />
                Tools for Educators
              </h1>
                    ...
                    >
                      <div className="flex-shrink-0 w-12 h-12 rounded-full">
                        <img
                          src={src}
                          alt="management"
                          className="h-full w-full object-cover rounded-full -ml-4"
                        />
                      </div>
                      <div
                        className={`w-32 h-4 ${
                          index % 2 === 0 ? "bg-[#3189EF]" : "bg-[#3AC6F2]"
                        } rounded`}
                      ></div>
                    </div>
                  ))}
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-7/12 p-5 relative">
            <div className="bg-white rounded-2xl relative ">
              ...
              <div className="absolute top-2 left-4 p-2 rounded-full shadow-lg flex space-x-1">
                ...
                <FontAwesomeIcon
                  icon={faCircle}
                  className="text-[#F6C566] text-xs"
                />
                <FontAwesomeIcon
                  icon={faCircle}
                  className="text-[#5BEB7B] text-xs"
                />
              </div>
          ...
          <div className="w-full md:w-5/12 p-5">
            <div className="p-5">
              <h1 className="text-3xl font-medium leading-tight">
                One-on-One <br />{" "}
                <span className="text-[#49BBBD]">Discussions</span>
              </h1>
                  ...
                  <div className="row">
                            ...
                            <div className="col-sm-6 col-12" key={index}>
                              <div className="ex-m-book">
                                <div className="ex-book-mob">
                                  <div
                                    className={`ex-mob-02 exb-0${index + 1}`}
                                  >
                                    <div>{text}</div>
                                  </div>
                                </div>
                    ...
                    <div className="col-md-6">
                      <div className="ex-c-inner">
                        <div className="ex-book-img">
                          <img
                            src={`assest/media/course-0${i + 1}.png`}
                            alt="Lorem Ipsum"
                            className="img-fluid"
                          />
                        </div>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 p-5">
            <div className="p-5">
              ...
              <h1 className="text-3xl font-semibold my-5 text-[#2F327D]">
                What They Say?
              </h1>
              <p className="my-6 text-base text-[#696984] font-normal">
                TOTC has got more than 100k positive ratings <br /> from our
              ...
              <button className="border border-[#49BBBD] px-10 py-3 bg-transparent rounded-full text-[#49BBBD] text-sm mt-8">
          ...
          <div className="w-full md:w-1/3 p-5 relative">
            ...
            <div className="absolute -bottom-[3rem] -right-[17rem] bg-white shadow-lg border-l-4 border-[#F67766] rounded-lg p-10">
              <p className="text-[#5F5F7E] max-w-md">
              ...
              <div className="flex justify-between items-center mt-6">
                <h4 className="text-[#5F5F7E] text-xl font-medium">
                  Gloria Rose
                </h4>
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-[#696984] ml-3 ">
                    12 reviews at Yelp
                  </p>
                </div>
              </div>
      ...
      <div className="max-w-screen-xl mx-auto my-40 p-5">
        <h1 className="text-2xl text-[#2F327D] text-center font-medium mb-2">
          Latest News and Resources
        </h1>
        <p className="text-center text-base text-[#696984] font-normal">
        ...
        <div className="mt-12 flex flex-wrap">
          ...
          <div className="w-full lg:w-1/2 p-5">
            <div className="p-5">
              ...
              />
              <button className="mt-8 border-none bg-[#49BBBD] text-white py-2 px-6 rounded-full text-sm">
                NEWS
              </button>
              <h4 className="text-[#252641] text-lg font-medium mt-4">
                Class adds $30 million to its balance sheet for a Zoom-friendly
                edtech solution
              </h4>
              <p className="text-[#696984] text-sm mt-2">
                Class, launched less than a year ago by Blackboard co-founder
                Michael Chasen, integrates exclusively...
              </p>
              <a href="#" className="text-[#696984] text-base mt-8 block">
                Read more
              </a>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 p-5">
            <div className="space-y-10">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-[#252641] text-lg font-medium">
